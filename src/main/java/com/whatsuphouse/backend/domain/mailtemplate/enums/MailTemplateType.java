...
public enum MailTemplateType {
    ...
    APPLICATION_PENDING(
            ...
            Map.of("이름", "홍길동", "모임명", "재즈가 흐르는 와인 모임",
                    ...
                    "조회경로", "https://www.whatsup.house/applications/result?token=sample-token")
    ),
    ...
    APPLICATION_APPROVED(
            ...
            """,
            List.of("이름", "모임명", "모임날짜", "시작시간", "결제링크"),
            Map.of("이름", "홍길동", "모임명", "재즈가 흐르는 와인 모임",
                    "모임날짜", "2026년 06월 26일", "시작시간", "19:00",
                    "결제링크", "https://www.whatsup.house/applications/result?token=sample-token")
    ),
    ...
    TICKET_PURCHASE_REQUESTED(
            ...
            """,
            List.of("이름", "이용권명", "결제금액", "입금계좌", "예금주", "결제링크"),
            Map.of("이름", "홍길동", "이용권명", "우연한 식탁 4회권",
    ...
    APPLICATION_CONFIRMED(
            ...
            {{확정링크라벨}}: {{확정링크}}
            """,
            List.of("이름", "확정안내문구", "모임명", "모임날짜", "시작시간", "확정링크라벨", "확정링크"),
            Map.of("이름", "홍길동", "모임명", "재즈가 흐르는 와인 모임",
                    "모임날짜", "2026년 06월 26일", "시작시간", "19:00",
                    "확정안내문구", "참가가 승인되었습니다. 아래 링크에서 입금 계좌를 확인하고 입금해 주세요. 입금 확인 후 예약이 최종 확정됩니다.",
                    "확정링크라벨", "입금 안내 확인",
                    "확정링크", "https://www.whatsup.house/applications/result?token=sample-token")
    ),
